...
/**
 * Example demonstrating the usage of CubisLang translation library with Mart
 * System demo data.
 */
        ...
        try (
                ...
                CubisLang lang = new CubisLang(
                        CubisLangOptions.builder()
                                ...
                                .setPreloadLocales(Arrays.asList("en", "zh"))
                                .setResourcePath("./resources/lang/") // Path to language files
                                ...
                                .setRemoteTranslationUrl(
                                        "https://raw.githubusercontent.com/cubetiq/cubis-langx-java/refs/heads/main/demo/martsystem/lang/") // URL
                                                                                                                                            // for
                                                                                                                                            // remote
                                                                                                                                            // translations
                                ...
                                .setOnTranslationErrorListener((locale, error) -> {
                                    System.err
                                            .println("Error loading translations for locale " + locale + ": " + error);
            ...
            System.out.println("\n=== CubisLang Simple Example Complete ===");
            lang.shutdown();
        }
    }
}
